/**
  @page Zigbee_Occupancy_Sensor application
  
  @verbatim
  ******************************************************************************
  * @file    Zigbee/Zigbee_Occupancy_Sensor/readme.txt 
...
This application act as an Occupancy Sensor as describe in the Zigbee documentation 19-02016 from CSA.
...
This device is a ZED with the following Zigbee clusters: Occupancy.
It extends the Zigbee RUC Lighting.

@par Keywords

Zigbee, RUC, Realistic Use Cases, Light, OnOff, Sensor, PIR, End Point, Occupancy
