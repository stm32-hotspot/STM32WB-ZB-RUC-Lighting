/**
  @page Zigbee_Light_Switch application
  
  @verbatim
  ******************************************************************************
  * @file    Zigbee/Zigbee_Light_Switch/readme.txt 
...
This application act as a Light Switch.
...
This device is a ZED with the following Zigbee clusters: OnOff and level.

@par Keywords

Zigbee, RUC, Realistic Use Cases, Light, OnOff, level, End Point
