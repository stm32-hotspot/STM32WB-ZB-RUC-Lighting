...
enum ZclStatusCodeT light_level_server_move_to_level_cb(
  struct ZbZclClusterT *clusterPtr, struct ZbZclLevelClientMoveToLevelReqT *req, struct ZbZclAddrInfoT *srcInfo, void *arg);
enum ZclStatusCodeT light_level_server_move_cb(
  struct ZbZclClusterT *clusterPtr, struct ZbZclLevelClientMoveReqT *req, struct ZbZclAddrInfoT *srcInfo, void *arg);
