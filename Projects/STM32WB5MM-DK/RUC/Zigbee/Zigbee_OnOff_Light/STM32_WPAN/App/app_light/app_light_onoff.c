/**
  ...
  * @brief   Application interface for OnOff functionnalities for Light EndPoint
  ******************************************************************************
  * @attention
  *
...
OnOff_Control_T * App_Light_OnOff_Cfg(struct ZigBeeT *zb)
{
  ...
  ZbZclClusterEndpointRegister(app_OnOff.onoff_server);
 ...
 */
enum ZclStatusCodeT light_onoff_server_off_cb
 ...
 * @retval stack status code
 */
enum ZclStatusCodeT light_onoff_server_on_cb
(struct ZbZclClusterT *clusterPtr, struct ZbZclAddrInfoT *srcInfo, void *arg)
{ 
  if (app_OnOff.On == 1)
  {
